 ...
 *
 * Written by: (the stack overflow users, obviously!) Apache Commons VFS dependency removed by crysxd (why were we using
 * that!?) https://github.com/crysxd Headerified, refactored and commented by Code Bling
 * http://stackoverflow.com/users/675721/code-bling Network file support added by Stefan Cordes
 * http://stackoverflow.com/users/81330/stefan-cordes Adapted by Sam Brightman http://stackoverflow.com/users/2492/sam-brightman
 * Based on information in 'The Windows Shortcut File Format' by Jesse Hager &lt;jessehager@iname.com&gt; And somewhat
 * based on code from the book 'Swing Hacks: Tips and Tools for Killer GUIs' by Joshua Marinacci and Chris Adamson ISBN:
